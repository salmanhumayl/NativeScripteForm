...
export class LoginService {
    ...
    ApprovedRequest(UserName:string):Observable<PendingApproval[]>
    {

        return this.http.get<PendingApproval[]>(`${this.serverUrl +'/api/Dashboard/ApprovedRequest?UserName='}${UserName}`);
